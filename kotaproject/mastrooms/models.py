...
class Room(models.Model):
    ...
    image1 = models.ImageField(upload_to='mastrooms/static/media',blank=True,null=True)
    image2 = models.ImageField(upload_to='mastrooms/static/media',blank=True,null=True)
    image3 = models.ImageField(upload_to='mastrooms/static/media',blank=True,null=True)
    image4 = models.ImageField(upload_to='mastrooms/static/media',blank=True,null=True)
